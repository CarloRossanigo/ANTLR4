...
public enum Functions {
    ...
    public double Eval(double arg) {
        switch (this) {
            ...
            case LN: 
                if (arg <= 0) throw new ArithmeticException("Logaritmo naturale di un numero negativo o zero non supportat");
                return Math.log(arg); 
            case ACOS: 
            ...
            default: throw new UnsupportedOperationException("Funzione non supportata: " + this);
        }
    }
}
